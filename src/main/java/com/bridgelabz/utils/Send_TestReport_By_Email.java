...
public class Send_TestReport_By_Email {
    public static void main(String[] args) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress("Mayurmansukh99@gmail.com"));

            // Set the recipient address
            message.setRecipients(javax.mail.Message.RecipientType.TO,InternetAddress.parse("Mayurmansukh99@gmail.com"));
